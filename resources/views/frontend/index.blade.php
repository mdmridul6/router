		...
		<div class="welcome-slider-area">
			<div id="welcome-slide-carousel" class="carousel slide carousel-fade" data-ride="carousel">
				<div class="carousel-inner" role="listbox">
					...
					<div class="item" style="background-image: url({{asset('frontend/images/slider/2.jpg')}}); background-size: cover;">
				...
				<div class="col-md-6 col-sm-6 col-xs-12 wow fadeInRight text-center">
					<div class="about_slider owl-carousel">
						<div class="about_image">
							<img src="{{asset('frontend/images/about/1.jpg')}}" alt="{{asset('frontend/images/about/1.jpg')}}" />
						</div>
						<div class="about_slider">
							<img src="{{asset('frontend/images/about/2.jpg')}}" alt="{{asset('frontend/images/about/2.jpg')}}" />
						</div>
						<div class="about_slider">
							<img src="{{asset('frontend/images/about/3.jpg')}}" alt="{{asset('frontend/images/about/3.jpg')}}" />
						</div>
					</div>
				</div> <!-- END COL -->
			</div>
