...
@section('content')
    <div id="kt_content_container" class="container-fluid">
        <div class="card  card-shadow-sm">
            ...
            <div class="card-body">
                <form action="{{ route('admin.seller.update',['seller'=>$data->id]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <div class="image-input image-input-circle" data-kt-image-input="true"
                                ...
                                <div class="image-input-wrapper w-125px h-125px"
                                     style="background-image: url('{{(isset($data->image)) ? asset($data->image) : asset("backend/assets/media/avatars/blank.png") }}')"></div>
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                ...
                                <div class="mb-10">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="userName"
                                           placeholder="Input Seller User Name" value="{{(old('userName') ? old('userName') : $data->userName )}}"/>
                                </div>
                                ...
                                <div class="mb-10">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="fullName"
                                           placeholder="Input Seller Full Name" value="{{(old('fullName') ? old('fullName') : $data->fullName )}}" />
                                </div>
                                ...
                                <div class="mb-10">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="nid"
                                           placeholder="Input NID Number" value="{{(old('nid') ? old('nid') : $data->nid )}}" />
                                </div>
                                ...
                                <div class="mb-10">
                                    ...
                                    <input type="tel" class="form-control form-control-solid" name="phone"
                                           placeholder="Enter Phone Number" value="{{(old('phone') ? old('phone') : $data->phone )}}" />
                                </div>
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                <div class="mb-10">
                                    ...
                                    <input type="tel" class="form-control form-control-solid" name="mobile"
                                           placeholder="Enter Phone Number" value="{{(old('mobile') ? old('mobile') : $data->mobile )}}" />
                                </div>
                                <div class="mb-10">
                                    <label for="email" class="required form-label">Email</label>
                                    <input type="email" class="form-control form-control-solid" name="email"
                                           placeholder="Enter Email" value="{{(old('email') ? old('email') : $data->email )}}" />
                                </div>
                                ...
                                <div class="mb-10">
                                    ...
                                    <textarea name="address" class="form-control form-control-solid" id="" cols="30"
                                              rows="10">{{(old('address') ? old('address') : $data->address )}}</textarea>
                                </div>
