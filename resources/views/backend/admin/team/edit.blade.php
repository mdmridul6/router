...
<div id="kt_content_container" class="container-fluid">
    <div class="card  card-shadow-sm">
        ...
        <div class="card-body">
            <form action="{{route('admin.cms.team.edit',$data['team']->id)}}" method="POST"
                    ...
                    <div class="col-12 col-sm-12 col-md-2 col-lg-2 col-xl-2">
                        ...
                        <div class="image-input image-input-circle" data-kt-image-input="true"
                            ...
                            <div class="image-input-wrapper w-125px h-125px"
                                style="background-image: url('{{(isset($data['team']->image)) ? asset($data['team']->image) : asset("
                    ...
                    <div class="col-12 col-sm-12 col-md-10 col-lg-10 col-xl-10">
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-2">
                                ...
                                <input type="text" name="name" class="form-control" value="{{$data['team']->name}}"
                                    required>
                            </div>
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-2">
