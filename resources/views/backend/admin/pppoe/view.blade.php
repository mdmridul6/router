                            ...
                            <div class="card-body pt-3">
                                ...
                                @if ($data['pppoeData']->status)
                                    ...
                                    <div class="d-flex align-items-sm-center mb-7">
                                        ...
                                        <div class="d-flex flex-row-fluid flex-wrap align-items-center">
                                            <div class="flex-grow-1 me-2">
                                                <p class="text-gray-800 fw-bolder text-hover-primary fs-6">Remote Address
                                                </p>
                                            </div>
                                            <p class="text-gray-800 fw-bolder text-hover-primary fs-6">
                                                {{ $data['remoteLink'] }}
                                ...
                                <div class="d-flex align-items-sm-center mb-7">
                                    ...
                                    <div class="d-flex flex-row-fluid flex-wrap align-items-center">
                                        ...
                                        <p class="text-gray-800 fw-bolder text-hover-primary fs-6">
                                            {{ $data['pppoeData']->active_date != null ? $data['pppoeData']->active_date->isoFormat('D-MMM-YYYY') : '' }}
                                        </p>
                                    </div>
                                    <!--end::Title-->
                                </div>
                                    ...
                                    <div class="d-flex flex-row-fluid flex-wrap align-items-center">
                                        ...
                                        <p class="text-gray-800 fw-bolder text-hover-primary fs-6">
                                            {{ $data['pppoeData']->package_active_date != null
                                                ? $data['pppoeData']->package_active_date->isoFormat('D-MMM-YYYY')
                                                : '' }}
                                        </p>
                                    </div>
                                    <!--end::Title-->
                                ...
                                <div class="d-flex align-items-sm-center mb-7">
                                    ...
                                    <div class="d-flex flex-row-fluid flex-wrap align-items-center">
                                        ...
                                        <p class="text-gray-800 fw-bolder text-hover-primary fs-6">
                                            {{ $data['pppoeData']->package_expire_date != null
                                                ? $data['pppoeData']->package_expire_date->isoFormat('D-MMM-YYYY')
                                                : '' }}
                                        </p>
                                    </div>
                                    <!--end::Title-->
                                ...
                                <div class="d-flex align-items-sm-center mb-7">
                                    ...
                                    <div class="d-flex flex-row-fluid flex-wrap align-items-center">
                                        ...
                                        <p class="text-gray-800 fw-bolder text-hover-primary fs-6">
                                            ...
                                            {{ $data['pppoeData']->status ? 'Active' : 'Deactive' }}
                                        </p>
                                    </div>
                                    <!--end::Title-->
                                </div>
                                @if (!isset($data['remoteLink']))
                                    <div class="d-flex align-items-sm-center mb-7">
                                        <!--begin::Title-->
                                        <div class="d-flex flex-row-fluid flex-wrap align-items-center">
                                            <div class="flex-grow-1 me-2">
                                                <p class="text-gray-800 fw-bolder text-hover-primary fs-6">Inactive Since
                                                </p>
                                            </div>
                                            <p id="inactiveSince" class="text-gray-800 fw-bolder text-hover-primary fs-6">
                                    ...
                                    <div class="d-flex flex-row-fluid flex-wrap align-items-center">
                                        ...
                                        <p class="text-gray-800 fw-bolder text-hover-primary fs-6">
                                            {{ isset($data['pppoeData']->seller->userName)
                                                ? $data['pppoeData']->seller->userName
                                                : "No
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                Seller" }}
                                        </p>
                                    </div>
...
@if ($data['pppoeData']->status)
    ...
    @section('js')
        ...
        <script>
            // Create a specific date (in this example, one hour ago)
            const specificDate = new Date("{{ $data['pppoeUserData'][0]['last-logged-out'] }}");
            specificDate.setHours(specificDate.getHours());
