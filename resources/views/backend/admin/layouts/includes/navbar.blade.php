                                ...
                                <div class="d-flex flex-column px-9">
                                    ...
                                    <div class="text-center px-4">
                                        <img class="mw-100 mh-200px" alt="metronic"
                                            src="{{asset('backend/assets/media/illustrations/work.png')}}" />
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                                <!--end::Wrapper-->
                ...
                <div class="d-flex align-items-stretch flex-shrink-0">
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click"
                            ...
                            <img src="{{(isset($seller->image)) ? asset($seller->image) : asset("backend/assets/media/avatars/blank.png") }}" alt="" />
                        </div>
                        <!--begin::Menu-->
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img alt="Logo" src="{{(isset($seller->image)) ? asset($seller->image) : asset("backend/assets/media/avatars/blank.png") }}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Username-->
