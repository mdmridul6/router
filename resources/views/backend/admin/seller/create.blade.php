                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            ...
                            <div class="mb-10">
                                ...
                                <input type="text" class="form-control form-control-solid" name="userName"
                                    placeholder="Input Seller User Name" value="{{old('userName')}}" />
                            </div>
                            ...
                            <div class="mb-10">
                                ...
                                <input type="text" class="form-control form-control-solid text-capitalize"
                                    name="fullName" placeholder="Input Seller Full Name" value="{{old('fullName')}}" />
                            </div>
                            ...
                            <div class="mb-10">
                                ...
                                <input type="text" class="form-control form-control-solid" name="nid"
                                    placeholder="Input NID Number" value="{{old('nid')}}" />
                            </div>
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            ...
                            <div class="mb-10">
                                ...
                                <div class="input-group w-md-100" data-kt-dialer="true" data-kt-dialer-min="0"
                                    ...
                                    <input type="text" class="form-control" name="deactiveAfter" readonly placeholder=""
                                        value="0" data-kt-dialer-control="input" />
                                    <!--end::Input control-->
                            ...
                            <div class="mb-10">
                                ...
                                <textarea name="address" class="form-control form-control-solid" id="" cols="20"
